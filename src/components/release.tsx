...
export const ReleaseItem = ({ project }: { project: any }) =>
    <div className="w-[370px] h-[400px] p-[40px] gap-[24px] rouned-[20px] hover:bg-black hover:shadow-lg transition-all duration-300 ease-in-out hover:text-white group rounded-[4px] border-[3px] boder-solid border-black ">
