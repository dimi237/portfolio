...
const Hero: React.FC = () => {
    ...
    return (
        <section>
            <div className="mt-35 flex items-center justify-between">
                <div className="flex flex-col gap-6 items-start w-3/6">
                ...
                <HeroIllustration className='z-0 absolute right-26 top-35' />
            </div>
        </section >
    );
};
