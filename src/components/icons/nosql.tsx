...
export const NoSqlIcon: React.FC<SGVProps> = ({ className, height, width }) => <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width || 20} height={height || 20}  viewBox="0 0 32 32" className={className} version="1.1" baseProfile="full" enable-background="new 0 0 76.00 76.00">
