...
export const SpringIcon: React.FC<SGVProps> = ({ className, width, height }) =>
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width || 20} height={height || 20} className={className} viewBox="0 0 24 24">
