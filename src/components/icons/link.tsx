...
export const LinkIcon: React.FC<SGVProps> = ({ className, width, height }) =>  <svg width={width || 20} height={height || 20} className={className} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
