export const ExpereinceItem = ({ experience }: { experience: any }) =>
    <div key={experience?.label} className="rounded-[8px] border-[1px] boder-solid border-zinc-500 px-[24px] py-[30px] hover:bg-brown transition-all duration-300 ease-in-out cursor-pointer max-w-[1000px]">
