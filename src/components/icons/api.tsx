...
export const ApiIcon: React.FC<SGVProps> = ({ className, width, height }) =>
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width || 20} height={height || 20} className={className} viewBox="0 0 48 48">
        ...
        <path d="M23 32L27 28" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" className={className}/>
        <path d="M6 42L11 37" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" className={className} />
        <path d="M16 25L20 21" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" className={className} />
    </svg>
